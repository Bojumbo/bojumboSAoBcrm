...
export type Service = Omit<PrismaService, 'price'> & {
    price: number;
};
export type Warehouse = PrismaWarehouse;
export type Sale = PrismaSale;
export type Project = Omit<PrismaProject, 'forecast_amount'> & {
    forecast_amount: number;
};
export type SubProject = Omit<PrismaSubProject, 'cost'> & {
    cost: number;
};
...
export interface SaleWithRelations extends Sale {
    ...
    products?: (PrismaSaleProduct & {
        product: Product;
    })[];
    services?: (PrismaSaleService & {
        service: Service;
    })[];
    total_price?: number;
}
