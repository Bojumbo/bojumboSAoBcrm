...
import { CreateSaleData } from '@/services/salesService';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export default function SaleForm({ open, onOpenChange, onSubmit, loading = false }: SaleFormProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Додати новий продаж</DialogTitle>
          <DialogDescription>
            Заповніть форму для створення нового продажу
          </DialogDescription>
        </DialogHeader>
